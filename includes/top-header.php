            ...
            <div class="cnt-account">
                <ul class="list-unstyled">
                    ...
                    <?php if (strlen($_SESSION['login'])) {
                        ?>
                        <li><a href="#"></i>Welcome - <?php echo htmlentities($_SESSION['username']); ?></a></li>
                    <?php } ?>


                          <li><a href="about.php"></i>About Us</a></li>
                           <li><a href="contactus.php"></i>Contact Us</a></li>
                            <li><a href="policy.php"></i>Policy</a></li>
                    ...
                    <li><a href="my-wishlist.php"><i class="icon fa fa-heart"></i>Wishlist</a></li>
                     <li><a href="my-cart.php"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
                        <li><a href="order-history.php"></i>Order History</a></li>
