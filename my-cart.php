...
if (isset($_POST['ordersubmit1'])) {
        ...
        foreach ($value as $qty => $val34) {
            ...
            mysqli_query($con, "insert into orders(userId,productId,quantity) values('" . $_SESSION['id'] . "','$qty','$val34')");
            header('location:payment-method_1.php');
        }
    }
?>
...
//print_r($_SESSION['pid'])=$pdtid;exit;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "RM" . " " . ($_SESSION['cart'][$row['id']]['quantity'] * $row['productPrice'] + $row['shippingCharge']); ?>.00</span></td>
                                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <label class="info-title" for="Shipping State ">Address: </label> <?php
                                            $qry = mysqli_query($con, "select * from users where id='" . $_SESSION['id'] . "'");
                                            while ($rt = mysqli_fetch_array($qry)) {
                                                echo htmlentities($rt['shippingAddress']) . "<br />";
                                            }
                                                ?>
                                                    <label class="info-title" for="Shipping City ">City: </label>    <?php
                                                $qry = mysqli_query($con, "select * from users where id='" . $_SESSION['id'] . "'");
                                                while ($rt = mysqli_fetch_array($qry)) {
                                                ...
                                                ?>
                                                    ...
                                                    <label class="info-title" for="Shipping State ">State: </label>    <?php
                                                $qry = mysqli_query($con, "select * from users where id='" . $_SESSION['id'] . "'");
                                                while ($rt = mysqli_fetch_array($qry)) {
                                                ...
                                                ?>
                                                    ...
                                                    <label class="info-title" for="Shipping Postcode ">Postcode: </label>    <?php
                                                $qry = mysqli_query($con, "select * from users where id='" . $_SESSION['id'] . "'");
                                                while ($rt = mysqli_fetch_array($qry)) {
                                        ...
                                        <tr>
                                            <td>
                                                <div class="cart-checkout-btn pull-right">
                                                    ...
                                                    <button type="submit" name="ordersubmit1" class="btn btn-primary">PROCCED TO CHEKOUT (Guest Mode)</button>
                                                    <div class="item">
            ...
            paypal.Button.render({
                ...
                payment: function (data, actions) {
                    return actions.payment.create({
                        transactions: [{
                                amount: {
                                    total: '<?php echo $productData['productPrice']; ?>',
