...
if(!is_dir($dir)){
	...
	$sql=mysqli_query($con,"insert into products(category,productName,productPriceBeforeDiscount,productPrice,productDescription,shippingCharge,productAvailability,productImage1) values('$category','$productname','$productpricebd','$productprice','$productdescription','$productscharge','$productavailability','$productimage1')");
