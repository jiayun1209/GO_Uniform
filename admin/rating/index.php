...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">List of Rating Measurement</h3>
            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT v.*, r.*, m.* from `vendor` v, rating r, rating_measurement m where r.vendor_ID = v.vendor_ID and r.performance_ID = m.performance_ID ");
