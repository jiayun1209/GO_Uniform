...
<div class="card card-outline card-info">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_m/manage_pr&id=<?php echo $id ?>">Edit</a>
            <a class="btn btn-sm btn-flat btn-default" href="?page=purchase_m">Back</a>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        <?php
                        if (isset($id)):
                            $pr_qry = $conn->query("SELECT o.*,i.name, i.description, i.item_code FROM `purchase_requisitions_details` o inner join inventory i on o.item_id = i.id where o.`pr_id` = '$id' ");
                            $total = 0;
