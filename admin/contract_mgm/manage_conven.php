...
<div class="card card-outline card-info">
    <div class="card-header">
        ...
        <div class="card-tools">            
            <a class="btn btn-sm btn-flat btn-primary" href="?page=contract_mgm/view_conven&id=<?php echo $id ?>">View</a>
                ...
                <div class="col-md-12">
                    <table class="table table-striped table-bordered" id="item-list">
                        ...
                        <tbody>
                            <?php
                            if (isset($id)):                               
                                $sub = $conn->query("SELECT c.*, s.* from contract c, vendor s where c.vendor_ID = s.vendor_ID and c.id = '$id'");
                                echo $conn->error;
                                while ($row = $sub->fetch_assoc()):
                                    ...
                                    <tr class="po-item" data-id="">
                                        <td class="align-middle p-1 text-center">
                                         ...
                                         <td class="align-middle p-1 sub_id "><?php echo $row['vendor_ID'] ?></td>                                                                             
