    ...
    <div class="card-body" id="out_print">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h2 class="text-center"><b>CONTRACT AGREEMENT</b></h2>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                ...
                <STRONG>
                            ...
                            while ($row = $rfq_qry->fetch_assoc()):
                                ...
                                <tr class=rfq-item" data-id="">
                                    ...
                                    <td class="align-middle p-0 text-center">
                                        <input type="date" class="text-center w-100 border-0" value="<?php echo $row['endDate'] ?>"/>
                                    </td>                            
                                </tr>
                                <?php
                            endwhile;
                    ...
                    <div class="row">
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <label for="remarks" class="control-label">Employee Sign Here:</label>
                            <textarea name="remarks" id="remarks" cols="10" rows="4" class="form-control rounded-0"></textarea>
                        </div>
            </div>
        </div>
    </div>
