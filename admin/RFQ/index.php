...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="?page=purchase_orders/manage_rfq" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>Create New</a>
            <a href="?page=purchase_orders/manage_rfq_pr" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>Create New with PR</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT r.*, s.name as sname FROM `rfq` r inner join `vendor` s on r.vendor_ID  = s.vendor_ID order by unix_timestamp(r.date_updated) ");
                        while ($row = $qry->fetch_assoc()):
                            $row['quantity_request'] = $conn->query("SELECT * FROM rfq where rfq_id = '{$row['rfq_ID']}'")->num_rows;
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php echo number_format($row['quantity_request']) ?></td>
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item" href="?page=purchase_orders/view_rfq&rfq_ID=<?php echo $row['rfq_ID'] ?>"><span class="fa fa-eye text-primary"></span> View</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="?page=purchase_orders/manage_rfq&id=<?php echo $row['rfq_ID'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
                                        <div class="dropdown-divider"></div>
