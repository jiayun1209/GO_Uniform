...
$date1 = date("Y-m-d", strtotime($deadline));
...
$qNum = $supplier['q_ID'];
$pr_ID = $supplier['pr_ID'];

if (isset($_POST['sendMailBtn'])) {
    foreach ($_POST['myCheck'] as $item) {
        ...
        <div class="row mb-2">
            ...
            <div class="col-6 row">
                ...
                <div class="col-6">
                  ...
                  <div class="col-6">
                    <p  class="m-0"><b>PR. #  ' . $pr_ID . '</b></p>                   
                </div>
            <div class="col-6">
                    <p  class="m-0"><b>Deadline: ' . $date1 . '</b></p>            
            ...
            <table class="table table-striped table-bordered" id="item-list">
                ...
                <thead>
                    <tr class="bg-navy disabled">
                        ...
                        <th class="px-1 py-1 text-center">Company Code</th>
                        <th class="px-1 py-1 text-center">Supplier Name</th>
