                                ...
                                while ($row = $rfq_qry->fetch_assoc()):
                                    ...
                                    <tr class="rfq-item" data-id="">
                                        <td class="align-middle p-1 text-center">
                                            <input type="text" class="text-center w-100 border-0" step="any" name="material_details"value="<?php echo($material_details) ? $material_details : "" ?>"/>
                                        </td>
                                         <td class="align-middle p-1 text-center">
                                            <input type="number" class="text-center w-100 border-0" step="any" name="quantity_request[]"value="<?php echo($quantity_request) ? $quantity_request : "" ?>"/>
                                        </td>    
                                        <td class="align-middle p-1 text-center">
                                            <input type="number" class="text-center w-100 border-0" step="any" name="unit_price[]"value="<?php echo($unit_price) ? $unit_price : "" ?>"/>
                                        </td>                  
...
<table class="d-none" id="item-clone">
    <tr class="rfq-item" data-id="">
        ...
        <td class="align-middle p-1">
            <input type="text" class="text-center w-100 border-0" name="unit_price[]"/>
        </td>
         <td class="align-middle p-1">
...
<script>
    ...
    $(document).ready(function(){
     ...
     tr.find('[name="quantity_request[]"],[name="unit_price[]"]').trigger('keypress')
     })
     }else{
