                                ...
                                while ($row = $order_items_qry->fetch_assoc()):
                                    ...
                                    <tr class="po-item" data-id="">
                                        ...
                                        <td class="align-middle p-1">
                                            ...
                                            <input type="text" id="item_name" name="item_name" class="text-center w-100 border-0 item_id" value="<?php echo $row['name'] ?>" required/>
                                        </td>
...
<table class="d-none" id="item-clone">
    <tr class="po-item" data-id="">
        ...
        <td class="align-middle p-0 text-center">
            <input type="number" class="text-center w-100 border-0" value="1" step="any" name="qty[]" required/>
        </td>
        <td class="align-middle p-1">
            <input type="hidden" name="item_id[]">
            <input type="text" id="item_name" name="item_name" class="text-center w-100 border-0 item_id" required/>
        </td>
        ...
        for (var i = 0; i < elements.length; i++) {
            elements[i].oninvalid = function (e) {
                ...
                if (!e.target.validity.valid) {
                    e.target.setCustomValidity("Please select a template.");
                }
            };
