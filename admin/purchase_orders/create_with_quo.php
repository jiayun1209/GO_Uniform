                ...
                <div class="col-md-12">
                    <table class="table table-striped table-bordered" id="item-list">
                                ...
                                while ($row = $order_items_qry->fetch_assoc()):
                                    ...
                                    <tr class="po-item" data-id="">
                                        ...
                                        <td class="align-middle p-0 text-center">
                                            <input type="number" class="text-center w-100 border-0" step="any" id="qty[]" name="qty[]" value="<?php echo $row['quantity'] ?>" required/>
                                        </td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th class="p-1 text-right" colspan="7"><span><button class="btn btn btn-sm btn-flat btn-primary py-0 mx-1" type="button" id="add_row">Add Row</button>
                            </tr>
                            <tr>
