...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><b><?php echo isset($id) ? "Update Purchase Order Details" : "Create Recurring Purchase Order" ?></b> </h3>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
        <button class="btn btn-flat btn-primary" form="po-form">Save as Template</button>
