							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
								  	<a class="dropdown-item" href="?page=material_m/view_mr&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="?page=material_m/manage_mr&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("Reservaton Details","material_m/view_mr.php?id="+$(this).attr('data-id'),'mid-large')
		})
	...
	function delete_rent($id){
		start_loader();
		$.ajax({
			url:_base_url_+"classes/Master.php?f=delete_mr",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
