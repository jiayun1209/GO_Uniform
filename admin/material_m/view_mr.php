...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><b><?php echo isset($id) ? "MR Details" : "New MR" ?></b></h3>
        <div class="card-tools">
            <button class="btn btn-sm btn-flat btn-success" id="print" type="button"><i class="fa fa-print"></i> Print</button>
            <a class="btn btn-sm btn-flat btn-primary" href="?page=material_m/manage_mr&id=<?php echo $id ?>">Edit</a>
            <a class="btn btn-sm btn-flat btn-default" href="?page=material_m">Back</a>
        </div>
    </div>
    <div class="card-body" id="out_print">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h2 class="text-center"><b>Material Requisition</b></h2>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                ...
                <?php
                $sta_qry = $conn->query("SELECT s.* FROM `staff` s  where s.`id` = '{$staff_id}' ");
               $staff = $sta_qry->fetch_array();
                ?>
                <div>
                    <p class="m-0"><b><?php echo $staff['firstname'] ?></b></p>                 
         ...
         <div class="col-6 row">
                <div class="col-6">
                    <p  class="m-0"><b>MR. #:</b></p>
                    <p><b><?php echo $mr_no ?></b></p>
                </div>
                <div class="col-6">
            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        <?php
                        if (isset($id)):
                            $mr_qry = $conn->query("SELECT o.*,i.name, i.description, i.item_code FROM `materials_requisitions_details` o inner join inventory i on o.item_id = i.id where o.`mr_id` = '$id' ");
                            $total = 0;
