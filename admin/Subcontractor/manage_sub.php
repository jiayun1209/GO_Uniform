...
<form action="" id="supplier-form">
    <input type="hidden" name="subcontractor_ID" value="<?php echo($subcontractor_ID) ? $subcontractor_ID : "" ?>" readonly>
...
<script>
    $(function () {
        $('#supplier-form').submit(function (e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=save_subcontractor",
