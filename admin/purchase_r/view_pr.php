...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><b><?php echo isset($id) ? "PR Details" : "New PR" ?></b></h3>
        <div class="card-tools">
            <button class="btn btn-sm btn-flat btn-success" id="print" type="button"><i class="fa fa-print"></i> Print</button>
            <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_r/manage_pr&id=<?php echo $id ?>">Edit</a>
    ...
    <div class="card-body" id="out_print">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <h2 class="text-center"><b>PURCHASE REQUISITION</b></h2>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                <p class="m-0"><b>Staff Details</b></p>
                <?php
                $sta_qry = $conn->query("SELECT s.*,c.* FROM `staff` s inner join company c on s.company_code = c.company_code where s.`staff_ID` = '{$staff_ID}' ");
                $staff = $sta_qry->fetch_array();
                ?>
                <div>
                    <p class="m-0"><?php echo $staff['company_code'] ?> - <?php echo $staff['name'] ?></p>                 
                    <p class="m-0"><?php echo $staff['email'] ?></p>
                    <p class="m-0"><?php echo $staff['address'] ?></p>
            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        <?php
                        if (isset($id)):
                            $pr_qry = $conn->query("SELECT o.*,i.name, i.description, i.item_code FROM `purchase_requisition_details` o inner join inventory i on o.item_id = i.id where o.`pr_id` = '$id' ");
