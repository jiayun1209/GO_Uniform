    ...
    <div class="card-body ml-5 mr-5" id="out_print">
        ...
        <table class="table table-hover table-striped" id="datatables">
            ...
            <tbody>
                <?php
                $i = 1;
                $qry = $conn->query("SELECT pr.*, s.firstname as sfname, s.lastname as slname FROM `purchase_requisitions` pr inner join `staff` s on pr.staff_id  = s.id order by unix_timestamp(pr.date_updated) ");
